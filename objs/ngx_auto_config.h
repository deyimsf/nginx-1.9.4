#define NGX_CONFIGURE " --prefix=/export/servers/nginx --with-pcre=/My/Tool/pcre-8.35"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "clang 6.0 (clang-600.0.57) (based on LLVM 3.5svn)"
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/export/servers/nginx/"
#endif
